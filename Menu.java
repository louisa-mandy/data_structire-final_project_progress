    ...
    public static void handleMenu() {
        ...
        switch (user_input) {
            ...
            case 2: // coffee
                ...
                HashMap<Integer, Double> Coffee_Prices = new HashMap<>();

                //Adding the prices to each key and storing to its according value
                Coffee_Prices.put(1, 3.60); // in dollars $ 
                Coffee_Prices.put(2, 4.32);
                Coffee_Prices.put(3, 5.26);
                Coffee_Prices.put(4, 4.02);
                Coffee_Prices.put(5, 5.28);
                Coffee_Prices.put(6, 3.56);
                Coffee_Prices.put(7, 6.58);
                ...
                if (key != null) {
                    ...
                    System.out.println("Price: $" + Coffee_Prices.get(key));
                } else {
                    System.out.println("The entered drink is not available in the menu.");
                } 
